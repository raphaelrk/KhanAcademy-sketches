// https://www.khanacademy.org/computer-programming/tree-fractal-with-landscape/2328871791
    ...
    this.draw = function() {
        if(branches.length === 0) {
         ...
         stroke(158 + random(-30, 30),
                101 + random(-30, 10),
                41  + random(-30, 30));
         if(l < leafLengthCutoff) {
             // leaf color
             stroke(107 + random(-30, 30), 
                    150 + random(-30, 30), 
                    27 + random(-30, 30));
            if(leaves) {
                var widthDivisor = 10;
                image(leaf, 
                    x - width*l/stLength/widthDivisor/2, 
                    y - height*l/stLength/widthDivisor/2, 
                    width*l/stLength/widthDivisor, 
                    height*l/stLength/widthDivisor);
            }
